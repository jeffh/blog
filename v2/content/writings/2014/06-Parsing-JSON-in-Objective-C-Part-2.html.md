...
The domain knowledge are the specific values that are input and output. Names of
...
You can see the other refactors in the
...
To indicate that this protocol works for more than just JSON objects, we can
